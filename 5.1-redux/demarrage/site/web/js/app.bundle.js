...
var Video = function (_React$Component) {
	...
	_createClass(Video, [{
		...
		value: function handleSubmit(event) {
			...
			_superagent2.default.post(_config2.default.apiPath + '/videos/' + this.state.video.id + '/comments').send('content=' + encodeURIComponent(this.state.newComment)).then(function (response) {
