...
var _VideoList = __webpack_require__(36);

var _VideoList2 = _interopRequireDefault(_VideoList);

var _VideoForm = __webpack_require__(41);

var _VideoForm2 = _interopRequireDefault(_VideoForm);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_Video2.default, null)
// <VideoForm />
// <VideoList />
...
var Video = function (_React$Component) {
	...
	_createClass(Video, [{
		...
		value: function componentWillMount() {
			...
			_superagent2.default.get(_config2.default.apiPath + '/videos/' + this.id).then(function (response) {
				_this2.setState({ video: response.body });
			});
			this.fetchComments();
		}
	}, {
		...
		value: function fetchComments() {
			...
			_superagent2.default.get(_config2.default.apiPath + '/videos/' + this.id + '/comments').then(function (response) {
				_this3.setState({ comments: response.body });
			});
		}
	}, {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'h3',
								null,
								this.state.video ? this.state.video.title : 'Chargement en cours'
							),
							_react2.default.createElement(
								'p',
								null,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'button',
								{ type: 'submit', className: 'btn btn-default', disabled: this.state.newCommentLoading },
		...
		value: function handleSubmit(event) {
			...
			_superagent2.default.post(_config2.default.apiPath + '/videos/' + this.state.video.id + '/comments').send('content=' + encodeURIComponent(this.commentInput.value)).then(function (response) {
				_this5.setState({ newCommentLoading: false, newComment: '' });
...
var _VideoItem = __webpack_require__(37);
...
var VideoList = function (_React$Component) {
	...
	function VideoList() {
		...
		var _this = _possibleConstructorReturn(this, (VideoList.__proto__ || Object.getPrototypeOf(VideoList)).call(this));
	...
	_createClass(VideoList, [{
		...
		value: function componentWillMount() {
			...
			_superagent2.default.get(_config2.default.apiPath + '/videos').then(function (response) {
				_this2.setState({ videos: response.body });
			});
		}
	}, {
		key: 'render',
...
var VideoForm = function (_React$Component) {
	...
	function VideoForm() {
		...
		var _this = _possibleConstructorReturn(this, (VideoForm.__proto__ || Object.getPrototypeOf(VideoForm)).call(this));
	...
	_createClass(VideoForm, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ type: 'submit', className: 'btn btn-default', disabled: this.state.isLoading },
		...
		value: function handleSubmit(event) {
			...
			_superagent2.default.post(_config2.default.apiPath + '/videos').field('title', this.titleInput.value).field('description', this.descriptionInput.value).attach('file', this.fileInput.files[0]).then(function (response) {
