...
exports.COMMENT_INPUT = exports.POST_COMMENT_COMPLETE = exports.POST_COMMENT_LOADING = exports.COMMENT_LIST_COMPLETE = exports.VIDEO_COMPLETE = exports.POST_VIDEO_COMPLETE = exports.POST_VIDEO_LOADING = exports.VIDEO_LIST_COMPLETE = undefined;
...
// Liste Vidéos
var VIDEO_LIST_COMPLETE = exports.VIDEO_LIST_COMPLETE = 'VIDEO_LIST_COMPLETE';
// Ajout video
var POST_VIDEO_LOADING = exports.POST_VIDEO_LOADING = 'POST_VIDEO_LOADING';
var POST_VIDEO_COMPLETE = exports.POST_VIDEO_COMPLETE = 'POST_VIDEO_COMPLETE';
// détail vidéo
var VIDEO_COMPLETE = exports.VIDEO_COMPLETE = 'VIDEO_COMPLETE';
// liste commentaires
var COMMENT_LIST_COMPLETE = exports.COMMENT_LIST_COMPLETE = 'COMMENT_LIST_COMPLETE';
// ajout commentaire
var POST_COMMENT_LOADING = exports.POST_COMMENT_LOADING = 'POST_COMMENT_LOADING';
var POST_COMMENT_COMPLETE = exports.POST_COMMENT_COMPLETE = 'POST_COMMENT_COMPLETE';
var COMMENT_INPUT = exports.COMMENT_INPUT = 'COMMENT_INPUT';
...
var _newComment = __webpack_require__(85);

var _newComment2 = _interopRequireDefault(_newComment);

var _newVideo = __webpack_require__(86);

var _newVideo2 = _interopRequireDefault(_newVideo);

var _videos = __webpack_require__(87);
...
exports.default = (0, _redux.combineReducers)({
	...
	newComment: _newComment2.default,
	newVideo: _newVideo2.default,
...
var _VideoList = __webpack_require__(80);

var _VideoList2 = _interopRequireDefault(_VideoList);

var _VideoForm = __webpack_require__(82);

var _VideoForm2 = _interopRequireDefault(_VideoForm);
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(16),A=__webpack_require__(5),B=__webpack_require__(2),ca=__webpack_require__(17),da=__webpack_require__(18),ea=__webpack_require__(19),ha=__webpack_require__(20),ia=__webpack_require__(21),C=__webpack_require__(7);
...
function mapDispatchToProps(dispatch) {
	return (0, _redux.bindActionCreators)({
		fetchVideo: _actions.fetchVideo,
		fetchComments: _actions.fetchComments,
		postComment: _actions.postComment,
		updateCommentInput: _actions.updateCommentInput }, dispatch);
}
...
var Video = function (_React$Component) {
	...
	function Video() {
		...
		_this.handleCommentInputChange = _this.handleCommentInputChange.bind(_this);
		return _this;
	}
	...
	_createClass(Video, [{
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'h3',
								null,
								this.props.video ? this.props.video.title : 'Chargement en cours'
							),
							_react2.default.createElement(
								'p',
								null,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'button',
								{ type: 'submit', className: 'btn btn-default', disabled: this.props.newComment.isLoading },
		...
		value: function renderComments() {
			return this.props.comments.map(function (comment) {
				return _react2.default.createElement(
					'div',
					{ key: comment.id, className: 'panel panel-default' },
					_react2.default.createElement(
						'div',
...
var _VideoItem = __webpack_require__(81);
...
function mapDispatchToProps(dispatch) {
	...
	return (0, _redux.bindActionCreators)({ fetchVideos: _actions.fetchVideos }, dispatch);
}
...
function mapDispatchToProps(dispatch) {
	return (0, _redux.bindActionCreators)({ postVideo: _actions.postVideo }, dispatch);
}

var VideoForm = function (_React$Component) {
	_inherits(VideoForm, _React$Component);

	function VideoForm(props) {
		_classCallCheck(this, VideoForm);

		var _this = _possibleConstructorReturn(this, (VideoForm.__proto__ || Object.getPrototypeOf(VideoForm)).call(this, props));
	...
	_createClass(VideoForm, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ type: 'submit', className: 'btn btn-default', disabled: this.props.isLoading },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(VideoForm);
...
exports.default = function () {
	...
	switch (action.type) {
		case _actions.COMMENT_LIST_COMPLETE:
...
exports.default = function () {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { comment: null, isLoading: false, input: '' };
	var action = arguments[1];

	switch (action.type) {
		case _actions.POST_COMMENT_LOADING:
			return {
				comment: null,
				isLoading: true,
				input: state.input
			};
		case _actions.POST_COMMENT_COMPLETE:
			return {
				comment: action.comment,
				isLoading: false,
				input: ''
			};
		case _actions.COMMENT_INPUT:
			return {
...
exports.default = function () {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { video: null, isLoading: false };
	var action = arguments[1];

	switch (action.type) {
		case _actions.POST_VIDEO_LOADING:
			return {
				video: action.video,
				isLoading: true
			};
		case _actions.POST_VIDEO_COMPLETE:
			return {
				video: action.video,
				isLoading: false
			};
...
exports.default = function () {
	...
	switch (action.type) {
		case _actions.VIDEO_LIST_COMPLETE:
