...
var _VideoList = __webpack_require__(29);
...
// <Video />
_react2.default.createElement(_VideoList2.default, null), document.getElementById('app'));
...
var _videos = __webpack_require__(15);
...
var Video = function (_React$Component) {
	...
	function Video() {
		...
		var index = Math.floor(Math.random() * _videos2.default.length);
		_this.state = {
			index: index,
			video: _videos2.default[index]
		};

		_this.handleNextVideoClick = _this.handleNextVideoClick.bind(_this);
		return _this;
	}
	...
	_createClass(Video, [{
		...
		key: 'handleNextVideoClick',
		value: function handleNextVideoClick() {
			var newIndex = (this.state.index + 1) % _videos2.default.length;
			this.setState({
				index: newIndex,
				video: _videos2.default[newIndex]
			});
		}
	}]);
...
var _VideoItem = __webpack_require__(30);
